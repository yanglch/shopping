 ...
 */
@Configuration
public class ModuleWebApplicationContext extends GenericWebApplicationContext {
     ...
     * @see #refresh
     */
    public ModuleWebApplicationContext(DefaultListableBeanFactory beanFactory) {
        super(beanFactory);
    }
